...
SELECT
    ...
    Flag_CCQ ,
    Flag_Agev_Esen ,
    TO_CHAR(Data_Firma,'yyyymmddhh24miss')               AS Data_Firma,
    TO_CHAR(Data_Accettazione,'yyyymmddhh24miss')        AS Data_Accettazione ,
    TO_CHAR(Data_CCQ,'yyyymmddhh24miss')                 AS Data_CCQ,
    TO_CHAR(Data_Caricamento,'yyyymmddhh24miss')         AS Data_Caricamento,
    TO_CHAR(Data_Invio_Contr_Tseller,'yyyymmddhh24miss') AS Data_Invio_Contr_Tseller,
    TO_CHAR(Data_Invio_Pre_Benv,'yyyymmddhh24miss')      AS Data_Invio_Pre_Benv,
    TO_CHAR(Data_Creazione_Offerta,'yyyymmddhh24miss')   AS Data_Creazione_Offerta,
    TO_CHAR(Data_Esito_Riascolto,'yyyymmddhh24miss')     AS Data_Esito_Riascolto ,
    Esito_Riascolto ,
    ...
    Ufficio
FROM
    dbi_user.IFC_SAP_CRM_OFF_TESTATA,
