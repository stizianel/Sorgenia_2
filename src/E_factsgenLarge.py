...
lfacts=[
        ...
        ("select legacy, tipo, operand, prog   from pfacts_f_dema a      where a.legacy = :key group by legacy,tipo,operand,prog ", "select legacy, tipo, ab, bis, lmenge      from pfacts_v_dema a       where a.legacy = :key and a.prog = :prog "),
