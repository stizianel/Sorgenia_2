...
#nome programma
log.testata("aggiornamento Temksv - PARTNER" )
...
conta=0
tota=0
cursor.execute("DELETE FROM Z_TEMKSV WHERE OBJECT = 'PARTNER'");
...
ITBOLT = sap_conn.read_table('TEMKSV',options=["object = 'PARTNER'"],fields=campi_temksv)
