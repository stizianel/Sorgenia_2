...
ExtractorManager('meterread2Extractor','meterreadExtractor',date = datetime.datetime.now(), filename = 'meterread91.xml', legacyValues = None,htmlMode=False,maxRows=1000000,dblog=False)