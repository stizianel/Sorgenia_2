...
#nome programma
log.testata("aggiornamento Temksv - DOCUMENT" )
...
conta=0
tota=0
cursor.execute("DELETE FROM Z_TEMKSV WHERE OBJECT = 'DOCUMENT'");
cursor.execute("COMMIT")
sql1 = "INSERT INTO Z_TEMKSV ("
log.writeInfo("Inizio estrazione da SAP")
ITBOLT = sap_conn.read_table('TEMKSV',options=["object = 'DOCUMENT'"],fields=campi_temksv,max_rows=600000)
